...
dados_analise %>%
  ...
  labs(
    ...
    subtitle = "Destaque: Ingredientes e Alimentos"
  )
...
dados_analise %>%
  ...
  labs(
    title = "Ranking de proporção de importação",
...
dados_analise %>%
  ...
  labs(
    title = "Ranking de valores de importação",
    subtitle = "Ingredientes naturais",
    x= "Valores em US$ bi",
    y="",
    fill = "Tipo país"
...
dados_analise %>%
  ...
  labs(
    title = "Ranking de proporção de importação",
    subtitle = "Madeira e produtos derivados",
    x= "(%)",
    y="",
    fill = "Tipo país"
  )
